...
| **`cortex_unified.ui.premium`** | `PremiumMainWindow`,<br>`PageSpec`, `TableBinding` | `load()`, `_refresh()`, `_run()` | Zero eager imports during bootstrap. All 132 tools load lazily on navigation. |
