...
class Scanner:
    ...
    def scan(
        self, threads: int = 0, checkpoint_id: Optional[str] = None, max_depth: int = 1000
        ...
        try:
            is_root_empty, empty_files, empty_dirs = self._scan_directory_enhanced(self.root_path, scan_state)
    ...
    def _scan_directory_enhanced(
        self, dirpath: Path, scan_state: dict, max_depth: int = 20
