...
class OperationProfiler:
    ...
    def end_operation(self) -> ProfileReport:
        ...
        report = ProfileReport(operation_name=self.current_operation, total_time=total_time)
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        for report in self.profiles:
            ...
            if name not in operations:
                operations[name] = {"count": 0, "total_time": 0.0, "min_time": float("inf"), "max_time": 0.0}
