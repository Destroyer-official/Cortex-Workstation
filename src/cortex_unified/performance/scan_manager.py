...
class ScanManager:
    ...
    def create_checkpoint(self, scan_state: Dict[str, Any]) -> str:
        ...
        with self._progress_lock:
            progress_percentage = (self._processed_count / self._total_count * 100) if self._total_count > 0 else 0.0
    ...
    def wait_if_paused(self) -> None:
        ...
        Blocks while paused and records progress for resume.
        """
    ...
    def get_scan_progress(self) -> ScanProgress:
        ...
        with self._progress_lock:
            ...
            percentage = (self._processed_count / self._total_count * 100) if self._total_count > 0 else 0.0
