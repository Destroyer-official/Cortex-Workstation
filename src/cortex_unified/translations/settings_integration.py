...
class I18nSettingsWidget(QWidget):
    ...
    def load_settings(self):
        ...
        self.high_contrast_cb.setChecked(self.settings.value("accessibility/high_contrast", False, type=bool))
        self.keyboard_nav_cb.setChecked(self.settings.value("accessibility/keyboard_navigation", True, type=bool))
        self.screen_reader_cb.setChecked(self.settings.value("accessibility/screen_reader", True, type=bool))
        self.font_size_spin.setValue(self.settings.value("accessibility/font_size", 10, type=int))
