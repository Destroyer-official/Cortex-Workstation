"""Safety infrastructure for Cortex Cleaner GUI operations."""

from .safety_manager import SafetyManager, Operation, OperationType, ValidationResult, OperationResult, SafetyError
