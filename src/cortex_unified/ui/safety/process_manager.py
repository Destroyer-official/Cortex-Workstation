...
class ProcessManager:
    ...
    def __init__(self, logger: Optional[logging.Logger] = None):
        ...
        self.blocked_executables: List[str] = [
            ...
            "format",
            "fdisk",
            "mkfs",  # Dangerous system commands
            "sudo",
            "su",
            ...
            "perl",
            "ruby",
            "node",  # Interpreters (unless specifically allowed)
        ]
    ...
    def set_security_policy(
        ...
        self.logger.info(
            f"Updated security policy: allowed={self.allowed_executables}, "
    ...
    def validate_executable(self, executable: str) -> str:
        ...
        try:
            ...
            if self.allowed_executables is not None and exe_name not in [
                allowed.lower() for allowed in self.allowed_executables
            ]:
