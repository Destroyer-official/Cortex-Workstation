...
class RegistryCleanerTab(BaseTab):
    ...
    def clean_registry(self):
        ...
        reply = QMessageBox.question(
            ...
            "Are you sure you want to sweep these entries? A backup will be generated first.",
        )
    ...
    def _on_clean_finished(self, count):
        ...
        QMessageBox.information(
            self, "Cleanup Complete", f"Successfully cleaned {count} orphaned registry entries. Backup generated."
        )
        self.registry_table.setRowCount(0)
        self.clean_registry_button.setEnabled(False)
