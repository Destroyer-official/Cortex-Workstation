...
class TooltipManager:
    ...
    TOOLTIPS = {
        ...
        "delete_large_files_button": {
            ...
            "help": "Permanently removes the selected large files. " "Review the list carefully before deletion.",
        },
        "min_size_spinbox": {
            "text": "Minimum file size in megabytes",
            "help": "Files smaller than this size will be ignored. " "Set higher values to find only very large files.",
        },
        # Disk Analyzer
        "analyze_disk_button": {
        ...
        "docker_networks_checkbox": {
            ...
            "help": "Finds Docker networks not used by any container. " "These are usually safe to remove.",
        },
        ...
        "package_clean_button": {
            ...
            "help": "Removes cached files and orphaned packages. Package lists are " "backed up before making changes.",
        },
        "pip_checkbox": {
        ...
        "conda_checkbox": {
            ...
            "help": "Scans Anaconda/Miniconda package manager cache. Includes both " "package cache and tarballs.",
        },
        ...
        "scan_symlinks_checkbox": {
            ...
            "help": "Scans for broken symbolic links on all platforms. " "These are usually safe to remove or repair.",
        },
        "scan_shortcuts_checkbox": {
            "text": "Include Windows shortcuts in scan",
            "help": "Scans for broken Windows .lnk shortcut files. " "Can attempt to find moved targets automatically.",
        },
        ...
        "announce_changes_checkbox": {
            ...
            "help": "Automatically announces important changes and progress updates " "to screen reader software.",
        },
        # Progress and Status
        "progress_bar": {
        ...
        "status_label": {
            ...
            "help": "Shows what operation is currently running and any important " "status messages or warnings.",
        },
        "results_table": {
        ...
        "export_json_button": {
            ...
            "help": "Saves the current results in JSON format for analysis or " "integration with other tools.",
        },
        "export_csv_button": {
            "text": "Export results to CSV file",
            "help": "Saves the current results in CSV format for analysis in " "spreadsheet applications.",
        },
    ...
    @classmethod
    def apply_tooltip(cls, widget: QWidget, tooltip_key: str, include_help: bool = False) -> None:
...
def setup_tooltips_and_help(main_window) -> None:
    ...
    if hasattr(main_window, "help_action"):
        main_window.help_action.triggered.connect(lambda: TooltipManager.show_help_dialog(main_window))
