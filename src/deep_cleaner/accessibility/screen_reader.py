...
class ScreenReaderSupport:
    ...
    def add_aria_labels(self, elements: List[Any]) -> None:
        ...
        try:
            for element in elements:
                ...
                # Set accessible name and description based on widget type
    ...
    def announce_changes(self, message: str) -> None:
        ...
        try:
            ...
            if HAS_PYSIDE6:
                QAccessible.updateAccessibility(QAccessible.AccessibleEvent(
                    QAccessible.Event.Alert, self.widget, 0
                ))
