"""Enhanced broken link detector for Deep Cleaner."""
...
class BrokenLinkDetector:
    ...
    def scan_all(self, path: str) -> List[BrokenLink]:
        """Scan for all types of broken links in the given path."""
        self.logger.info(f"Starting comprehensive broken link scan in: {path}")
