"""Comprehensive tooltip and help system for Deep Cleaner GUI."""
...
class TooltipManager:
    ...
    def show_help_dialog(cls, parent=None) -> None:
        ...
        dialog.setWindowTitle("Deep Cleaner Help")
        ...
        content = """
        <h2>Deep Cleaner Help</h2>
        
        <h3>Overview</h3>
        <p>Deep Cleaner is a comprehensive utility for finding and removing unnecessary files, 
...
def setup_tooltips_and_help(main_window) -> None:
    ...
    main_window.setWhatsThis(
        "Deep Cleaner main window. Use the tabs to access different cleanup tools. "
