...
class TestParse:
    ...
    def test_parses_boots_and_issues(self):
        """Verify parses boots and issues via BootPerformanceMonitor._parse."""
        payload = (
    ...
    def test_nameless_issue_skipped(self):
        """Verify nameless issue skipped via BootPerformanceMonitor._parse."""
    ...
    def test_bad_numbers_coerce_zero(self):
        """Verify bad numbers coerce zero via BootPerformanceMonitor._parse."""
...
class TestDataclasses:
    ...
    def test_issue_to_dict(self):
        """Verify issue to dict via BootIssue, to_dict."""
...
class TestSupport:
    ...
    def test_analyze_shape(self):
        """Verify analyze shape via BootPerformanceMonitor, analyze."""
