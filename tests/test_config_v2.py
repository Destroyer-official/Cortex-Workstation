...
class TestConfig:
    ...
    def test_nested_configuration(self):
        ...
        config = Config(scan={"min_age_days": 7}, security={"default_action": "trash"}, logging={"log_level": "DEBUG"})
...
"""
    ...
    def test_save_to_yaml(self, tmp_path):
        ...
        config = Config(scan={"min_age_days": 7}, security={"default_action": "trash"})
...
class TestConfigIntegration:
    ...
    def test_full_workflow(self, tmp_path):
        ...
        config1 = Config(scan={"min_age_days": 7}, security={"default_action": "trash"})
