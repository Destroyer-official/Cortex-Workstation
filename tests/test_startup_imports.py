...
def test_legacy_cli_still_exposes_every_command():
    ...
    # 22 commands including Next-Gen tools (clean-ai, clean-shaders, trim-ssd, verify-checksums, vss-health, demo).
    assert int(count) == 22, f"expected 22 commands, got {count}: {names}"
